    ...
    return (
      <main className='content'>
        ...
        <div className='flex'>
          ...
          <div className='row'>
            <p>Learning is cool, but knowing is better, and I know the key to success. You do know, you do know that they don’t want you to have lunch. I’m keeping it real with you, so what you going do is have lunch. Learning is cool, but knowing is better, and I know the key to success. I’m up to something. Celebrate success right, the only way, apple. It’s important to use cocoa butter. It’s the key to more success, why not live smooth? Why live rough? Surround yourself with angels.</p>
          </div>
        </div>
      </main>
    );
